...
const CalendarYearPickerTrigger = ({
  ...
  const monthYear = $bfcd16e7c55c9482$export$72ad8e10aa105341({}, state);
...
const CalendarYearPickerTriggerHeading = ({
  ...
  const state = useCalendarOrRangeState();
  const heading = $bfcd16e7c55c9482$export$72ad8e10aa105341({
    format,
    offset
  }, state);
...
const CalendarYearPickerGrid = ({
  ...
  const {
    ...
    onChange,
    value: focusedItemId
  } = $e4b70edea91ee6b0$export$89757cae093b4b95({
    format,
    visibleYears
  }, state);
