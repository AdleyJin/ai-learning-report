import { chain as $a4e76a5424781910$export$e08e3b67e392101e } from './chain.js';
import { mergeIds as $390e54f620492c70$export$cd8c9cb68f842629 } from './useId.js';
import { mergeRefs as $4064df0d6f9620e1$export$c9058316764c140e } from './mergeRefs.js';
...
function $bbaa08b3cd72f041$export$9d1611c77c2fe928(...args) {
    ...
    for(let i = 1; i < args.length; i++){
        ...
        for(let key in props){
            ...
            key[0] === 'o' && key[1] === 'n' && key.charCodeAt(2) >= /* 'A' */ 65 && key.charCodeAt(2) <= /* 'Z' */ 90) result[key] = ($a4e76a5424781910$export$e08e3b67e392101e)(a, b);
